...
class EntityVisitor:
    ...
    def visit_function(self, node) -> None:
        ...
        if self._current_class and node.type == "method_definition":
...
def parse_project(root_dir: str, use_lsp: bool = True) -> KnowledgeGraph:
    parser = CodeParser(root_dir, use_lsp=use_lsp)
